...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💬 Velisseya Maren Daily!\n\n#velisseyamaren"
        ...
        video = upload.video(
            ...
            name=title or 'Velisseya Maren Video',
...
def main():
    ...
    title = sys.argv[3] if len(sys.argv) > 3 else "Velisseya Maren"
