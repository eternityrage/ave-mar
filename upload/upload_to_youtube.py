...
def main():
    ...
    title = "Velisseya Maren Daily"
    description = "#shorts #velisseyamaren"
    tags = ['fashion', 'beauty', 'lifestyle', 'travel', 'style', 'boho', 'freespirit', 'photography', 'wellness', 'velisseyamaren', 'ootd', 'skincare', 'selfcare', 'inspiration', 'livefreely']
